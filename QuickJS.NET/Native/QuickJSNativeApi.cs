...
namespace QuickJS.Native
{
	...
	public static class QuickJSNativeApi
	{
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue js_std_await(JSContext ctx, JSValue obj);
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern JSClassID JS_GetClassID(JSValue v);
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool JS_HasException(JSContext ctx);
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool JS_StrictEq(JSContext ctx, [In] JSValue op1, [In] JSValue op2);

		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool JS_SameValue(JSContext ctx, [In] JSValue op1, [In] JSValue op2);

		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool JS_SameValueZero(JSContext ctx, [In] JSValue op1, [In] JSValue op2);
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue JS_NewDate(JSContext ctx, double epochMs);
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue JS_NewTypedArray(JSContext ctx, int argc, [In] JSValue argv, JSTypedArrayEnum array_type);
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public unsafe static extern JSPromiseStateEnum JS_PromiseState(JSContext ctx, JSValue promise);

		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public unsafe static extern JSValue JS_PromiseResult(JSContext ctx, JSValue promise);
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue JS_GetModuleNamespace(JSContext ctx, in JSModuleDef m);
		...
		[DllImport(QuickJsLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public unsafe static extern JSValue JS_LoadModule(JSContext* ctx, byte* basename, byte* filename);
